#ifndef MayaCache_H_INCLUDED
#define MayaCache_H_INCLUDED
...
typedef  struct Info
{
	...
	Channel *mayaChannels;		// cache channels
}Info;
...
void DLL_EXPORT enableChannel(CHANNELTYPE channelActive, ENABLEDISABLED ea, int cacheId);
